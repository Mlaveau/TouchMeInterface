...
camomile = function(){
	...
	camomile.set_corpus = function(callbackfunction, idCorpus, name){
		this.put(camomile.route(idCorpus), corpus(name), callbackfunction);
	}
	...
	camomile.create_media = function(callbackFunction, idCorpus, name, url){ 
		this.post(camomile.route(idCorpus) + "/media", media(name, url), callbackFunction);
	}

	/* Set Media */
	camomile.set_media = function(callbackFunction, idCorpus, idMedia, name, url){
		this.put(camomile.route(idCorpus, idMedia), media(name, url), callbackFunction);
	}
	...
	camomile.create_layer = function(callbackFunction, idCorpus, idMedia, layertyp, fragmenttyp, datatyp, source){
		this.post(camomile.route(idCorpus, idMedia) + "/layer", layer(layertyp, fragmenttyp, datatyp, source), callbackFunction);
	}

	/* Set Layer */
	camomile.set_layer = function(callbackFunction, idCorpus, idMedia, idLayer, layertyp, fragtyp, datatyp, source){
		this.put(camomile.route(idCorpus, idMedia, idLayer), layer(layertyp, fragtyp, datatyp, source), callbackFunction);
	}
	...
	camomile.create_annotation = function(callbackFunction, idCorpus, idMedia, idLayer, frag, dat){
		this.post(camomile.route(idCorpus, idMedia, idLayer) + "/annotation", annotation(frag, dat), callbackFunction);
	}

	/* Set Annotation*/
	camomile.set_annotation = function(callbackFunction, idCorpus, idMedia, idLayer, idAnnotation, frag, dat){
		this.put(camomile.route(idCorpus, idMedia, idLayer, idAnnotation), annotation(frag, dat), callbackFunction);
	}
